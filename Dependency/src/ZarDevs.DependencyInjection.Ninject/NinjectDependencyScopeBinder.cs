...
namespace ZarDevs.DependencyInjection
{
    ...
    /// </summary>
    public class NinjectDependencyScopeBinder : DependencyScopeBinderBase<IKernel>
    {
        #region Fields
        ...
        /// </exception>
        public NinjectDependencyScopeBinder(IDependencyFactory dependencyFactory) : base(DependyBuilderScopes.Singleton | DependyBuilderScopes.Transient | DependyBuilderScopes.Thread)
        {
